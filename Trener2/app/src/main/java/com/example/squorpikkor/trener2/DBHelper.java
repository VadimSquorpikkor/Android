...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_EXERCISE2 = "exercise2";

    public static final String KEY_ID = "_id";
    public static final String KEY_RESULT = "result";
    public static final String KEY_HISTORY_RECORD_COUNT = "historyRecordCount";
    public static final String KEY_NEW_WEIGHT_COUNT = "newWeightCount";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_EXERCISE1 + "("
                ...
                + KEY_HISTORY_RECORD_COUNT + " text," + KEY_NEW_WEIGHT_COUNT + " text,"
                + KEY_DATE + " text" + ")");
