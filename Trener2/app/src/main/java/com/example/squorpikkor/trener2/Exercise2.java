...
public class Exercise2 extends AppCompatActivity {
    ...
    public void  addToDB(){
        ...
        ////contentValues.put(DBHelper.KEY_DAY_RECORD_COUNT, dayRecord);
    ...
    public void loadVariables(){
        //  if(sPref.contains(SAVED_WEIGHT_VALUE)&&
        //        sPref.contains(SAVED_QUANTITY_VALUE)&&
        //      sPref.contains(SAVED_BEST_WEIGHT)&&
        //    sPref.contains(SAVED_SUM_OF_WEIGHT)&&
        //  sPref.contains(SAVED_BEST_SUM_OF_WEIGHT)){
        sPref = getPreferences(MODE_PRIVATE);
